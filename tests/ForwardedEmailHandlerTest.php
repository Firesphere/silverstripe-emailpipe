...
class ForwardedEmailHandlerTest extends SapphireTest {
	...
	function setUp() {
		...
		ForwardedEmailHandler::$email_sender_domains = array('yourcompany.com');
	...
	function testMultipartAttachementForwardFromClient() {
		...
		$this->assertEquals($newEmail->Subject, 'Multipart Inline Forward', "Subject exists and doesn't contain 'Fwd:'");
